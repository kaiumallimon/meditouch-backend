...
router.post("/add",permissionMiddleware('write'),upload.single('image'),communityController.addCommunityPosts); // add post
...
router.put("/update/:id",permissionMiddleware('write'),upload.single('image'),communityController.updateCommunityPost); // update post
